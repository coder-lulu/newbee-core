...
const (
	...
	Core_InitTenantData_FullMethodName                      = "/core.Core/initTenantData"
...
type CoreClient interface {
	...
	// group: tenant
	InitTenantData(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*BaseResp, error)
	//  Token management
	//  group: token
...
func (c *coreClient) InitTenantData(ctx context.Context, in *IDReq, opts ...grpc.CallOption) (*BaseResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BaseResp)
	err := c.cc.Invoke(ctx, Core_InitTenantData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CoreServer interface {
	...
	// group: tenant
	InitTenantData(context.Context, *IDReq) (*BaseResp, error)
	//  Token management
	//  group: token
...
func (UnimplementedCoreServer) InitTenantData(context.Context, *IDReq) (*BaseResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method InitTenantData not implemented")
}
...
func _Core_InitTenantData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(IDReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CoreServer).InitTenantData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Core_InitTenantData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CoreServer).InitTenantData(ctx, req.(*IDReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Core_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "initTenantData",
			Handler:    _Core_InitTenantData_Handler,
		},
		{
