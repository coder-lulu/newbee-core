...
func (_c *TokenCreate) SetTenantID(v uint64) *TokenCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *TokenCreate) SetNillableTenantID(v *uint64) *TokenCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *TokenCreate) SetDepartmentID(v uint64) *TokenCreate {
	_c.mutation.SetDepartmentID(v)
	return _c
}

// SetNillableDepartmentID sets the "department_id" field if the given value is not nil.
func (_c *TokenCreate) SetNillableDepartmentID(v *uint64) *TokenCreate {
	if v != nil {
...
func (_c *TokenCreate) createSpec() (*Token, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(token.FieldTenantID, field.TypeUint64, value)
