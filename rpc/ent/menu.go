...
func (*Menu) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case menu.FieldID, menu.FieldSort, menu.FieldTenantID, menu.FieldParentID, menu.FieldMenuLevel, menu.FieldMenuType, menu.FieldDynamicLevel:
			values[i] = new(sql.NullInt64)
		case menu.FieldPath, menu.FieldName, menu.FieldRedirect, menu.FieldComponent, menu.FieldServiceName, menu.FieldPermission, menu.FieldTitle, menu.FieldIcon, menu.FieldFrameSrc, menu.FieldRealPath, menu.FieldParams:
