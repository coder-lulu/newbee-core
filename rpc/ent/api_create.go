...
func (_c *APICreate) SetTenantID(v uint64) *APICreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *APICreate) SetNillableTenantID(v *uint64) *APICreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *APICreate) check() error {
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`ent: missing required field "API.tenant_id"`)}
	}
...
func (_c *APICreate) createSpec() (*API, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(api.FieldTenantID, field.TypeUint64, value)
