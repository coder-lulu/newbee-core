...
type DepartmentEdges struct {
	...
	Posts []*Position `json:"posts,omitempty"`
...
// was not loaded in eager-loading.
func (e DepartmentEdges) PostsOrErr() ([]*Position, error) {
	if e.loadedTypes[3] {
		return e.Posts, nil
	}
...
// QueryPosts queries the "posts" edge of the Department entity.
func (_m *Department) QueryPosts() *PositionQuery {
	return NewDepartmentClient(_m.config).QueryPosts(_m)
}
