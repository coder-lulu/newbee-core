...
func (_u *DepartmentUpdate) AddPostIDs(ids ...uint64) *DepartmentUpdate {
	_u.mutation.AddPostIDs(ids...)
	return _u
}

// AddPosts adds the "posts" edges to the Position entity.
func (_u *DepartmentUpdate) AddPosts(v ...*Position) *DepartmentUpdate {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *DepartmentUpdate) ClearPosts() *DepartmentUpdate {
	_u.mutation.ClearPosts()
	return _u
}

// RemovePostIDs removes the "posts" edge to Position entities by IDs.
func (_u *DepartmentUpdate) RemovePostIDs(ids ...uint64) *DepartmentUpdate {
	_u.mutation.RemovePostIDs(ids...)
	return _u
}

// RemovePosts removes "posts" edges to Position entities.
func (_u *DepartmentUpdate) RemovePosts(v ...*Position) *DepartmentUpdate {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddPostIDs adds the "posts" edge to the Position entity by IDs.
func (_u *DepartmentUpdateOne) AddPostIDs(ids ...uint64) *DepartmentUpdateOne {
	_u.mutation.AddPostIDs(ids...)
	return _u
}

// AddPosts adds the "posts" edges to the Position entity.
func (_u *DepartmentUpdateOne) AddPosts(v ...*Position) *DepartmentUpdateOne {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearPosts clears all "posts" edges to the Position entity.
func (_u *DepartmentUpdateOne) ClearPosts() *DepartmentUpdateOne {
	_u.mutation.ClearPosts()
	return _u
}

// RemovePostIDs removes the "posts" edge to Position entities by IDs.
func (_u *DepartmentUpdateOne) RemovePostIDs(ids ...uint64) *DepartmentUpdateOne {
	_u.mutation.RemovePostIDs(ids...)
	return _u
}

// RemovePosts removes "posts" edges to Position entities.
func (_u *DepartmentUpdateOne) RemovePosts(v ...*Position) *DepartmentUpdateOne {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
