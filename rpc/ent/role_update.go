...
func (ru *RoleUpdate) SetDataScope(u uint8) *RoleUpdate {
	ru.mutation.ResetDataScope()
	ru.mutation.SetDataScope(u)
	return ru
}

// SetNillableDataScope sets the "data_scope" field if the given value is not nil.
func (ru *RoleUpdate) SetNillableDataScope(u *uint8) *RoleUpdate {
	if u != nil {
		ru.SetDataScope(*u)
	}
	return ru
...
func (ru *RoleUpdate) AddDataScope(u int8) *RoleUpdate {
	ru.mutation.AddDataScope(u)
	return ru
}

// SetCustomDeptIds sets the "custom_dept_ids" field.
func (ru *RoleUpdate) SetCustomDeptIds(u []uint64) *RoleUpdate {
	ru.mutation.SetCustomDeptIds(u)
	return ru
}

// AppendCustomDeptIds appends u to the "custom_dept_ids" field.
func (ru *RoleUpdate) AppendCustomDeptIds(u []uint64) *RoleUpdate {
	ru.mutation.AppendCustomDeptIds(u)
	return ru
}

// ClearCustomDeptIds clears the value of the "custom_dept_ids" field.
func (ru *RoleUpdate) ClearCustomDeptIds() *RoleUpdate {
	ru.mutation.ClearCustomDeptIds()
	return ru
}
...
func (ru *RoleUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ru.mutation.DataScope(); ok {
		_spec.SetField(role.FieldDataScope, field.TypeUint8, value)
	}
	if value, ok := ru.mutation.AddedDataScope(); ok {
		_spec.AddField(role.FieldDataScope, field.TypeUint8, value)
	}
	if value, ok := ru.mutation.CustomDeptIds(); ok {
		_spec.SetField(role.FieldCustomDeptIds, field.TypeJSON, value)
	}
	if value, ok := ru.mutation.AppendedCustomDeptIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, role.FieldCustomDeptIds, value)
		})
	}
	if ru.mutation.CustomDeptIdsCleared() {
		_spec.ClearField(role.FieldCustomDeptIds, field.TypeJSON)
	}
...
// SetDataScope sets the "data_scope" field.
func (ruo *RoleUpdateOne) SetDataScope(u uint8) *RoleUpdateOne {
	ruo.mutation.ResetDataScope()
	ruo.mutation.SetDataScope(u)
	return ruo
}

// SetNillableDataScope sets the "data_scope" field if the given value is not nil.
func (ruo *RoleUpdateOne) SetNillableDataScope(u *uint8) *RoleUpdateOne {
	if u != nil {
		ruo.SetDataScope(*u)
	}
	return ruo
...
// AddDataScope adds u to the "data_scope" field.
func (ruo *RoleUpdateOne) AddDataScope(u int8) *RoleUpdateOne {
	ruo.mutation.AddDataScope(u)
	return ruo
}

// SetCustomDeptIds sets the "custom_dept_ids" field.
func (ruo *RoleUpdateOne) SetCustomDeptIds(u []uint64) *RoleUpdateOne {
	ruo.mutation.SetCustomDeptIds(u)
	return ruo
}

// AppendCustomDeptIds appends u to the "custom_dept_ids" field.
func (ruo *RoleUpdateOne) AppendCustomDeptIds(u []uint64) *RoleUpdateOne {
	ruo.mutation.AppendCustomDeptIds(u)
	return ruo
}

// ClearCustomDeptIds clears the value of the "custom_dept_ids" field.
func (ruo *RoleUpdateOne) ClearCustomDeptIds() *RoleUpdateOne {
	ruo.mutation.ClearCustomDeptIds()
	return ruo
}
...
func (ruo *RoleUpdateOne) sqlSave(ctx context.Context) (_node *Role, err error) {
	...
	if value, ok := ruo.mutation.CustomDeptIds(); ok {
		_spec.SetField(role.FieldCustomDeptIds, field.TypeJSON, value)
	}
	if value, ok := ruo.mutation.AppendedCustomDeptIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, role.FieldCustomDeptIds, value)
		})
	}
	if ruo.mutation.CustomDeptIdsCleared() {
		_spec.ClearField(role.FieldCustomDeptIds, field.TypeJSON)
	}
