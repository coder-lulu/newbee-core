...
func (_u *RoleUpdate) SetDataScope(v uint8) *RoleUpdate {
...
func (_u *RoleUpdate) SetNillableDataScope(v *uint8) *RoleUpdate {
	if v != nil {
		_u.SetDataScope(*v)
	}
	return _u
...
func (_u *RoleUpdate) AddDataScope(v int8) *RoleUpdate {
	_u.mutation.AddDataScope(v)
	return _u
}

// SetCustomDeptIds sets the "custom_dept_ids" field.
func (_u *RoleUpdate) SetCustomDeptIds(v []uint64) *RoleUpdate {
	_u.mutation.SetCustomDeptIds(v)
	return _u
}

// AppendCustomDeptIds appends value to the "custom_dept_ids" field.
func (_u *RoleUpdate) AppendCustomDeptIds(v []uint64) *RoleUpdate {
	_u.mutation.AppendCustomDeptIds(v)
	return _u
}

// ClearCustomDeptIds clears the value of the "custom_dept_ids" field.
func (_u *RoleUpdate) ClearCustomDeptIds() *RoleUpdate {
	_u.mutation.ClearCustomDeptIds()
	return _u
}
...
func (_u *RoleUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.CustomDeptIds(); ok {
		_spec.SetField(role.FieldCustomDeptIds, field.TypeJSON, value)
	}
	if value, ok := _u.mutation.AppendedCustomDeptIds(); ok {
		_spec.AddModifier(func(u *sql.UpdateBuilder) {
			sqljson.Append(u, role.FieldCustomDeptIds, value)
		})
	}
	if _u.mutation.CustomDeptIdsCleared() {
...
// SetDataScope sets the "data_scope" field.
func (_u *RoleUpdateOne) SetDataScope(v uint8) *RoleUpdateOne {
	_u.mutation.ResetDataScope()
	_u.mutation.SetDataScope(v)
	return _u
}
...
// SetNillableDataScope sets the "data_scope" field if the given value is not nil.
func (_u *RoleUpdateOne) SetNillableDataScope(v *uint8) *RoleUpdateOne {
	if v != nil {
		_u.SetDataScope(*v)
	}
	return _u
...
// AddDataScope adds value to the "data_scope" field.
func (_u *RoleUpdateOne) AddDataScope(v int8) *RoleUpdateOne {
	_u.mutation.AddDataScope(v)
	return _u
}

// SetCustomDeptIds sets the "custom_dept_ids" field.
func (_u *RoleUpdateOne) SetCustomDeptIds(v []uint64) *RoleUpdateOne {
	_u.mutation.SetCustomDeptIds(v)
	return _u
}

// AppendCustomDeptIds appends value to the "custom_dept_ids" field.
func (_u *RoleUpdateOne) AppendCustomDeptIds(v []uint64) *RoleUpdateOne {
	_u.mutation.AppendCustomDeptIds(v)
	return _u
}

// ClearCustomDeptIds clears the value of the "custom_dept_ids" field.
func (_u *RoleUpdateOne) ClearCustomDeptIds() *RoleUpdateOne {
	_u.mutation.ClearCustomDeptIds()
	return _u
}
