...
func (_c *PositionCreate) SetTenantID(v uint64) *PositionCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *PositionCreate) SetNillableTenantID(v *uint64) *PositionCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *PositionCreate) SetDeptID(v uint64) *PositionCreate {
	_c.mutation.SetDeptID(v)
	return _c
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (_c *PositionCreate) SetNillableDeptID(v *uint64) *PositionCreate {
	if v != nil {
		_c.SetDeptID(*v)
	}
	return _c
...
func (_c *PositionCreate) SetDepartmentsID(id uint64) *PositionCreate {
...
func (_c *PositionCreate) SetNillableDepartmentsID(id *uint64) *PositionCreate {
	if id != nil {
...
func (_c *PositionCreate) SetDepartments(v *Department) *PositionCreate {
...
func (_c *PositionCreate) createSpec() (*Position, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(position.FieldTenantID, field.TypeUint64, value)
