...
func (pc *PositionCreate) SetDeptID(u uint64) *PositionCreate {
	pc.mutation.SetDeptID(u)
	return pc
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (pc *PositionCreate) SetNillableDeptID(u *uint64) *PositionCreate {
	if u != nil {
		pc.SetDeptID(*u)
	}
	return pc
...
func (pc *PositionCreate) SetDepartmentsID(id uint64) *PositionCreate {
...
func (pc *PositionCreate) SetNillableDepartmentsID(id *uint64) *PositionCreate {
	if id != nil {
		pc = pc.SetDepartmentsID(*id)
	}
	return pc
}
...
func (pc *PositionCreate) defaults() {
	...
	if _, ok := pc.mutation.DeptID(); !ok {
		v := position.DefaultDeptID
		pc.mutation.SetDeptID(v)
	}
}
