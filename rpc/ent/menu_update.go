...
func (mu *MenuUpdate) SetParams(s string) *MenuUpdate {
	mu.mutation.SetParams(s)
	return mu
}

// SetNillableParams sets the "params" field if the given value is not nil.
func (mu *MenuUpdate) SetNillableParams(s *string) *MenuUpdate {
	if s != nil {
		mu.SetParams(*s)
	}
	return mu
...
func (mu *MenuUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := mu.mutation.Params(); ok {
		_spec.SetField(menu.FieldParams, field.TypeString, value)
	}
	if mu.mutation.ParamsCleared() {
		_spec.ClearField(menu.FieldParams, field.TypeString)
	}
...
// SetParams sets the "params" field.
func (muo *MenuUpdateOne) SetParams(s string) *MenuUpdateOne {
	muo.mutation.SetParams(s)
	return muo
}

// SetNillableParams sets the "params" field if the given value is not nil.
func (muo *MenuUpdateOne) SetNillableParams(s *string) *MenuUpdateOne {
	if s != nil {
		muo.SetParams(*s)
	}
	return muo
