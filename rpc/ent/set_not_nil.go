...
// set field if value's pointer is not nil.
func (_m *RoleUpdate) SetNotNilDataScope(value *uint8) *RoleUpdate {
	if value != nil {
		return _m.SetDataScope(*value)
	}
	return _m
}

// set field if value's pointer is not nil.
func (_m *RoleUpdateOne) SetNotNilDataScope(value *uint8) *RoleUpdateOne {
	if value != nil {
		return _m.SetDataScope(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *RoleCreate) SetNotNilDataScope(value *uint8) *RoleCreate {
	if value != nil {
		return _m.SetDataScope(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantUpdate) SetNotNilContactPerson(value *string) *TenantUpdate {
	if value != nil {
		return _m.SetContactPerson(*value)
	}
	return _m
}

// set field if value's pointer is not nil.
func (_m *TenantUpdateOne) SetNotNilContactPerson(value *string) *TenantUpdateOne {
	if value != nil {
		return _m.SetContactPerson(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantCreate) SetNotNilContactPerson(value *string) *TenantCreate {
	if value != nil {
		return _m.SetContactPerson(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantUpdate) SetNotNilExpireTime(value *time.Time) *TenantUpdate {
	if value != nil {
...
// set field if value's pointer is not nil.
func (_m *TenantUpdateOne) SetNotNilExpireTime(value *time.Time) *TenantUpdateOne {
	if value != nil {
		return _m.SetExpireTime(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantCreate) SetNotNilExpireTime(value *time.Time) *TenantCreate {
	if value != nil {
		return _m.SetExpireTime(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantUpdate) SetNotNilMaxUsers(value *uint32) *TenantUpdate {
	if value != nil {
		return _m.SetMaxUsers(*value)
	}
	return _m
}

// set field if value's pointer is not nil.
func (_m *TenantUpdateOne) SetNotNilMaxUsers(value *uint32) *TenantUpdateOne {
	if value != nil {
		return _m.SetMaxUsers(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantCreate) SetNotNilMaxUsers(value *uint32) *TenantCreate {
	if value != nil {
		return _m.SetMaxUsers(*value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantUpdate) SetNotNilSettings(value []types.TenantSettings) *TenantUpdate {
	if value != nil {
		return _m.SetSettings(value)
	}
	return _m
}

// set field if value's pointer is not nil.
func (_m *TenantUpdateOne) SetNotNilSettings(value []types.TenantSettings) *TenantUpdateOne {
	if value != nil {
		return _m.SetSettings(value)
	}
	return _m
...
// set field if value's pointer is not nil.
func (_m *TenantCreate) SetNotNilSettings(value []types.TenantSettings) *TenantCreate {
	if value != nil {
		return _m.SetSettings(value)
	}
	return _m
