...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdate) SetNotNilListClass(value *string) *DictionaryDetailUpdate {
	if value != nil {
		return dd.SetListClass(*value)
	}
	return dd
}

// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdateOne) SetNotNilListClass(value *string) *DictionaryDetailUpdateOne {
	if value != nil {
		return dd.SetListClass(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailCreate) SetNotNilListClass(value *string) *DictionaryDetailCreate {
	if value != nil {
		return dd.SetListClass(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdate) SetNotNilCSSClass(value *string) *DictionaryDetailUpdate {
	if value != nil {
		return dd.SetCSSClass(*value)
	}
	return dd
}

// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdateOne) SetNotNilCSSClass(value *string) *DictionaryDetailUpdateOne {
	if value != nil {
		return dd.SetCSSClass(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailCreate) SetNotNilCSSClass(value *string) *DictionaryDetailCreate {
	if value != nil {
		return dd.SetCSSClass(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdate) SetNotNilIsDefault(value *uint32) *DictionaryDetailUpdate {
	if value != nil {
		return dd.SetIsDefault(*value)
	}
	return dd
}

// set field if value's pointer is not nil.
func (dd *DictionaryDetailUpdateOne) SetNotNilIsDefault(value *uint32) *DictionaryDetailUpdateOne {
	if value != nil {
		return dd.SetIsDefault(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (dd *DictionaryDetailCreate) SetNotNilIsDefault(value *uint32) *DictionaryDetailCreate {
	if value != nil {
		return dd.SetIsDefault(*value)
	}
	return dd
...
// set field if value's pointer is not nil.
func (m *MenuUpdate) SetNotNilParams(value *string) *MenuUpdate {
	if value != nil {
		return m.SetParams(*value)
	}
	return m
}

// set field if value's pointer is not nil.
func (m *MenuUpdateOne) SetNotNilParams(value *string) *MenuUpdateOne {
	if value != nil {
		return m.SetParams(*value)
	}
	return m
...
// set field if value's pointer is not nil.
func (m *MenuCreate) SetNotNilParams(value *string) *MenuCreate {
	if value != nil {
		return m.SetParams(*value)
	}
	return m
...
// set field if value's pointer is not nil.
func (po *PositionUpdate) SetNotNilDeptID(value *uint64) *PositionUpdate {
	if value != nil {
		return po.SetDeptID(*value)
	}
	return po
}

// set field if value's pointer is not nil.
func (po *PositionUpdateOne) SetNotNilDeptID(value *uint64) *PositionUpdateOne {
	if value != nil {
		return po.SetDeptID(*value)
	}
	return po
...
// set field if value's pointer is not nil.
func (po *PositionCreate) SetNotNilDeptID(value *uint64) *PositionCreate {
	if value != nil {
		return po.SetDeptID(*value)
	}
	return po
...
// set field if value's pointer is not nil.
func (r *RoleUpdate) SetNotNilDataScope(value *uint8) *RoleUpdate {
	if value != nil {
		return r.SetDataScope(*value)
	}
	return r
}

// set field if value's pointer is not nil.
func (r *RoleUpdateOne) SetNotNilDataScope(value *uint8) *RoleUpdateOne {
	if value != nil {
		return r.SetDataScope(*value)
	}
	return r
...
// set field if value's pointer is not nil.
func (r *RoleCreate) SetNotNilDataScope(value *uint8) *RoleCreate {
	if value != nil {
		return r.SetDataScope(*value)
	}
	return r
...
// set field if value's pointer is not nil.
func (r *RoleUpdate) SetNotNilCustomDeptIds(value []uint64) *RoleUpdate {
	if value != nil {
		return r.SetCustomDeptIds(value)
	}
	return r
}

// set field if value's pointer is not nil.
func (r *RoleUpdateOne) SetNotNilCustomDeptIds(value []uint64) *RoleUpdateOne {
	if value != nil {
		return r.SetCustomDeptIds(value)
	}
	return r
...
// set field if value's pointer is not nil.
func (r *RoleCreate) SetNotNilCustomDeptIds(value []uint64) *RoleCreate {
	if value != nil {
		return r.SetCustomDeptIds(value)
	}
	return r
