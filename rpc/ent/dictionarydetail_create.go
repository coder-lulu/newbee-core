...
func (ddc *DictionaryDetailCreate) SetListClass(s string) *DictionaryDetailCreate {
	ddc.mutation.SetListClass(s)
	return ddc
}

// SetNillableListClass sets the "list_class" field if the given value is not nil.
func (ddc *DictionaryDetailCreate) SetNillableListClass(s *string) *DictionaryDetailCreate {
	if s != nil {
		ddc.SetListClass(*s)
	}
	return ddc
...
func (ddc *DictionaryDetailCreate) SetCSSClass(s string) *DictionaryDetailCreate {
	ddc.mutation.SetCSSClass(s)
	return ddc
}

// SetNillableCSSClass sets the "css_class" field if the given value is not nil.
func (ddc *DictionaryDetailCreate) SetNillableCSSClass(s *string) *DictionaryDetailCreate {
	if s != nil {
		ddc.SetCSSClass(*s)
	}
	return ddc
...
func (ddc *DictionaryDetailCreate) SetIsDefault(u uint32) *DictionaryDetailCreate {
	ddc.mutation.SetIsDefault(u)
	return ddc
}

// SetNillableIsDefault sets the "is_default" field if the given value is not nil.
func (ddc *DictionaryDetailCreate) SetNillableIsDefault(u *uint32) *DictionaryDetailCreate {
	if u != nil {
		ddc.SetIsDefault(*u)
	}
	return ddc
...
func (ddc *DictionaryDetailCreate) defaults() {
	...
	if _, ok := ddc.mutation.ListClass(); !ok {
		v := dictionarydetail.DefaultListClass
		ddc.mutation.SetListClass(v)
	}
	if _, ok := ddc.mutation.CSSClass(); !ok {
		v := dictionarydetail.DefaultCSSClass
		ddc.mutation.SetCSSClass(v)
	}
	if _, ok := ddc.mutation.IsDefault(); !ok {
		v := dictionarydetail.DefaultIsDefault
