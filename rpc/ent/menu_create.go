...
func (_c *MenuCreate) SetTenantID(v uint64) *MenuCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *MenuCreate) SetNillableTenantID(v *uint64) *MenuCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *MenuCreate) SetNillableParams(v *string) *MenuCreate {
	if v != nil {
		_c.SetParams(*v)
	}
	return _c
...
func (_c *MenuCreate) createSpec() (*Menu, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(menu.FieldTenantID, field.TypeUint64, value)
