...
func (_c *ConfigurationCreate) SetTenantID(v uint64) *ConfigurationCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *ConfigurationCreate) SetNillableTenantID(v *uint64) *ConfigurationCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *ConfigurationCreate) defaults() {
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		v := configuration.DefaultTenantID
		_c.mutation.SetTenantID(v)
	}
}
...
func (_c *ConfigurationCreate) check() error {
	...
	if _, ok := _c.mutation.TenantID(); !ok {
		return &ValidationError{Name: "tenant_id", err: errors.New(`ent: missing required field "Configuration.tenant_id"`)}
	}
...
func (_c *ConfigurationCreate) createSpec() (*Configuration, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(configuration.FieldTenantID, field.TypeUint64, value)
