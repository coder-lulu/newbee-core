...
// was not loaded in eager-loading.
func (e UserEdges) OauthSessionsOrErr() ([]*OauthSession, error) {
	if e.loadedTypes[4] {
...
// QueryOauthSessions queries the "oauth_sessions" edge of the User entity.
func (_m *User) QueryOauthSessions() *OauthSessionQuery {
	return NewUserClient(_m.config).QueryOauthSessions(_m)
}
