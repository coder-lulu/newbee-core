...
func (_u *UserUpdate) AddOauthAccountIDs(ids ...uint64) *UserUpdate {
...
func (_u *UserUpdate) AddOauthSessionIDs(ids ...uint64) *UserUpdate {
	_u.mutation.AddOauthSessionIDs(ids...)
	return _u
}

// AddOauthSessions adds the "oauth_sessions" edges to the OauthSession entity.
func (_u *UserUpdate) AddOauthSessions(v ...*OauthSession) *UserUpdate {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) RemoveOauthAccountIDs(ids ...uint64) *UserUpdate {
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.OauthSessionsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.OauthSessionsTable,
			Columns: []string{user.OauthSessionsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddOauthAccountIDs adds the "oauth_accounts" edge to the OauthAccount entity by IDs.
func (_u *UserUpdateOne) AddOauthAccountIDs(ids ...uint64) *UserUpdateOne {
	_u.mutation.AddOauthAccountIDs(ids...)
	return _u
}
...
// AddOauthSessionIDs adds the "oauth_sessions" edge to the OauthSession entity by IDs.
func (_u *UserUpdateOne) AddOauthSessionIDs(ids ...uint64) *UserUpdateOne {
	_u.mutation.AddOauthSessionIDs(ids...)
	return _u
}

// AddOauthSessions adds the "oauth_sessions" edges to the OauthSession entity.
func (_u *UserUpdateOne) AddOauthSessions(v ...*OauthSession) *UserUpdateOne {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveOauthAccountIDs removes the "oauth_accounts" edge to OauthAccount entities by IDs.
func (_u *UserUpdateOne) RemoveOauthAccountIDs(ids ...uint64) *UserUpdateOne {
	_u.mutation.RemoveOauthAccountIDs(ids...)
	return _u
}
...
// ClearOauthSessions clears all "oauth_sessions" edges to the OauthSession entity.
func (_u *UserUpdateOne) ClearOauthSessions() *UserUpdateOne {
	_u.mutation.ClearOauthSessions()
	return _u
}

// RemoveOauthSessionIDs removes the "oauth_sessions" edge to OauthSession entities by IDs.
func (_u *UserUpdateOne) RemoveOauthSessionIDs(ids ...uint64) *UserUpdateOne {
	_u.mutation.RemoveOauthSessionIDs(ids...)
	return _u
}

// RemoveOauthSessions removes "oauth_sessions" edges to OauthSession entities.
func (_u *UserUpdateOne) RemoveOauthSessions(v ...*OauthSession) *UserUpdateOne {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
