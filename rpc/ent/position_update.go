...
func (pu *PositionUpdate) SetDeptID(u uint64) *PositionUpdate {
	pu.mutation.SetDeptID(u)
	return pu
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (pu *PositionUpdate) SetNillableDeptID(u *uint64) *PositionUpdate {
	if u != nil {
		pu.SetDeptID(*u)
	}
	return pu
...
func (pu *PositionUpdate) ClearDeptID() *PositionUpdate {
	pu.mutation.ClearDeptID()
	return pu
}
...
func (pu *PositionUpdate) SetDepartmentsID(id uint64) *PositionUpdate {
...
func (pu *PositionUpdate) SetNillableDepartmentsID(id *uint64) *PositionUpdate {
	if id != nil {
		pu = pu.SetDepartmentsID(*id)
	}
	return pu
}
...
// SetDeptID sets the "dept_id" field.
func (puo *PositionUpdateOne) SetDeptID(u uint64) *PositionUpdateOne {
	puo.mutation.SetDeptID(u)
	return puo
}

// SetNillableDeptID sets the "dept_id" field if the given value is not nil.
func (puo *PositionUpdateOne) SetNillableDeptID(u *uint64) *PositionUpdateOne {
	if u != nil {
		puo.SetDeptID(*u)
	}
	return puo
...
// ClearDeptID clears the value of the "dept_id" field.
func (puo *PositionUpdateOne) ClearDeptID() *PositionUpdateOne {
	puo.mutation.ClearDeptID()
	return puo
}
...
// SetDepartmentsID sets the "departments" edge to the Department entity by ID.
func (puo *PositionUpdateOne) SetDepartmentsID(id uint64) *PositionUpdateOne {
	puo.mutation.SetDepartmentsID(id)
	return puo
}

// SetNillableDepartmentsID sets the "departments" edge to the Department entity by ID if the given value is not nil.
func (puo *PositionUpdateOne) SetNillableDepartmentsID(id *uint64) *PositionUpdateOne {
	if id != nil {
		puo = puo.SetDepartmentsID(*id)
	}
	return puo
}
