...
func (_c *RoleCreate) SetTenantID(v uint64) *RoleCreate {
	_c.mutation.SetTenantID(v)
	return _c
}

// SetNillableTenantID sets the "tenant_id" field if the given value is not nil.
func (_c *RoleCreate) SetNillableTenantID(v *uint64) *RoleCreate {
	if v != nil {
		_c.SetTenantID(*v)
	}
	return _c
...
func (_c *RoleCreate) SetDataScope(v uint8) *RoleCreate {
	_c.mutation.SetDataScope(v)
	return _c
}

// SetNillableDataScope sets the "data_scope" field if the given value is not nil.
func (_c *RoleCreate) SetNillableDataScope(v *uint8) *RoleCreate {
	if v != nil {
		_c.SetDataScope(*v)
	}
	return _c
...
func (_c *RoleCreate) SetCustomDeptIds(v []uint64) *RoleCreate {
	_c.mutation.SetCustomDeptIds(v)
	return _c
}
...
func (_c *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.TenantID(); ok {
		_spec.SetField(role.FieldTenantID, field.TypeUint64, value)
	...
	if value, ok := _c.mutation.CustomDeptIds(); ok {
		_spec.SetField(role.FieldCustomDeptIds, field.TypeJSON, value)
		_node.CustomDeptIds = value
	}
