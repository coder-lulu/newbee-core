...
func (rc *RoleCreate) SetDataScope(u uint8) *RoleCreate {
	rc.mutation.SetDataScope(u)
	return rc
}

// SetNillableDataScope sets the "data_scope" field if the given value is not nil.
func (rc *RoleCreate) SetNillableDataScope(u *uint8) *RoleCreate {
	if u != nil {
		rc.SetDataScope(*u)
	}
	return rc
...
func (rc *RoleCreate) SetCustomDeptIds(u []uint64) *RoleCreate {
	rc.mutation.SetCustomDeptIds(u)
	return rc
}
...
func (rc *RoleCreate) createSpec() (*Role, *sqlgraph.CreateSpec) {
	...
	if value, ok := rc.mutation.CustomDeptIds(); ok {
