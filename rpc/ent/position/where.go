...
func TenantID(v uint64) predicate.Position {
...
func DeptID(v uint64) predicate.Position {
	return predicate.Position(sql.FieldEQ(FieldDeptID, v))
}
...
func DeptIDEQ(v uint64) predicate.Position {
	return predicate.Position(sql.FieldEQ(FieldDeptID, v))
}

// DeptIDNEQ applies the NEQ predicate on the "dept_id" field.
func DeptIDNEQ(v uint64) predicate.Position {
	return predicate.Position(sql.FieldNEQ(FieldDeptID, v))
}

// DeptIDIn applies the In predicate on the "dept_id" field.
func DeptIDIn(vs ...uint64) predicate.Position {
	return predicate.Position(sql.FieldIn(FieldDeptID, vs...))
}

// DeptIDNotIn applies the NotIn predicate on the "dept_id" field.
func DeptIDNotIn(vs ...uint64) predicate.Position {
	return predicate.Position(sql.FieldNotIn(FieldDeptID, vs...))
}

// DeptIDIsNil applies the IsNil predicate on the "dept_id" field.
func DeptIDIsNil() predicate.Position {
	return predicate.Position(sql.FieldIsNull(FieldDeptID))
}

// DeptIDNotNil applies the NotNil predicate on the "dept_id" field.
func DeptIDNotNil() predicate.Position {
	return predicate.Position(sql.FieldNotNull(FieldDeptID))
}
