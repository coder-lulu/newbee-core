...
func (_u *TokenUpdate) SetDepartmentID(v uint64) *TokenUpdate {
...
func (_u *TokenUpdate) SetNillableDepartmentID(v *uint64) *TokenUpdate {
	if v != nil {
...
func (_u *TokenUpdate) AddDepartmentID(v int64) *TokenUpdate {
	_u.mutation.AddDepartmentID(v)
	return _u
}

// ClearDepartmentID clears the value of the "department_id" field.
func (_u *TokenUpdate) ClearDepartmentID() *TokenUpdate {
...
func (_u *TokenUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.DepartmentID(); ok {
		_spec.SetField(token.FieldDepartmentID, field.TypeUint64, value)
	}
	if value, ok := _u.mutation.AddedDepartmentID(); ok {
		_spec.AddField(token.FieldDepartmentID, field.TypeUint64, value)
	}
	if _u.mutation.DepartmentIDCleared() {
		_spec.ClearField(token.FieldDepartmentID, field.TypeUint64)
	}
...
// SetDepartmentID sets the "department_id" field.
func (_u *TokenUpdateOne) SetDepartmentID(v uint64) *TokenUpdateOne {
	_u.mutation.ResetDepartmentID()
	_u.mutation.SetDepartmentID(v)
	return _u
}
...
// SetNillableDepartmentID sets the "department_id" field if the given value is not nil.
func (_u *TokenUpdateOne) SetNillableDepartmentID(v *uint64) *TokenUpdateOne {
	if v != nil {
		_u.SetDepartmentID(*v)
	}
	return _u
...
// AddDepartmentID adds value to the "department_id" field.
func (_u *TokenUpdateOne) AddDepartmentID(v int64) *TokenUpdateOne {
	_u.mutation.AddDepartmentID(v)
	return _u
}

// ClearDepartmentID clears the value of the "department_id" field.
func (_u *TokenUpdateOne) ClearDepartmentID() *TokenUpdateOne {
	_u.mutation.ClearDepartmentID()
	return _u
}
