...
func (_c *UserCreate) AddOauthAccountIDs(ids ...uint64) *UserCreate {
...
func (_c *UserCreate) AddOauthSessionIDs(ids ...uint64) *UserCreate {
	_c.mutation.AddOauthSessionIDs(ids...)
	return _c
}

// AddOauthSessions adds the "oauth_sessions" edges to the OauthSession entity.
func (_c *UserCreate) AddOauthSessions(v ...*OauthSession) *UserCreate {
	ids := make([]uint64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
