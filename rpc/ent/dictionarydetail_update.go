...
func (ddu *DictionaryDetailUpdate) SetListClass(s string) *DictionaryDetailUpdate {
	ddu.mutation.SetListClass(s)
	return ddu
}

// SetNillableListClass sets the "list_class" field if the given value is not nil.
func (ddu *DictionaryDetailUpdate) SetNillableListClass(s *string) *DictionaryDetailUpdate {
	if s != nil {
		ddu.SetListClass(*s)
	}
	return ddu
...
func (ddu *DictionaryDetailUpdate) ClearListClass() *DictionaryDetailUpdate {
	ddu.mutation.ClearListClass()
	return ddu
}

// SetCSSClass sets the "css_class" field.
func (ddu *DictionaryDetailUpdate) SetCSSClass(s string) *DictionaryDetailUpdate {
	ddu.mutation.SetCSSClass(s)
	return ddu
}

// SetNillableCSSClass sets the "css_class" field if the given value is not nil.
func (ddu *DictionaryDetailUpdate) SetNillableCSSClass(s *string) *DictionaryDetailUpdate {
	if s != nil {
		ddu.SetCSSClass(*s)
	}
	return ddu
...
func (ddu *DictionaryDetailUpdate) ClearCSSClass() *DictionaryDetailUpdate {
	ddu.mutation.ClearCSSClass()
	return ddu
}

// SetIsDefault sets the "is_default" field.
func (ddu *DictionaryDetailUpdate) SetIsDefault(u uint32) *DictionaryDetailUpdate {
	ddu.mutation.ResetIsDefault()
	ddu.mutation.SetIsDefault(u)
	return ddu
}

// SetNillableIsDefault sets the "is_default" field if the given value is not nil.
func (ddu *DictionaryDetailUpdate) SetNillableIsDefault(u *uint32) *DictionaryDetailUpdate {
	if u != nil {
		ddu.SetIsDefault(*u)
	}
	return ddu
...
func (ddu *DictionaryDetailUpdate) AddIsDefault(u int32) *DictionaryDetailUpdate {
	ddu.mutation.AddIsDefault(u)
	return ddu
}

// ClearIsDefault clears the value of the "is_default" field.
func (ddu *DictionaryDetailUpdate) ClearIsDefault() *DictionaryDetailUpdate {
	ddu.mutation.ClearIsDefault()
	return ddu
}
...
func (ddu *DictionaryDetailUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := ddu.mutation.ListClass(); ok {
		_spec.SetField(dictionarydetail.FieldListClass, field.TypeString, value)
	}
	if ddu.mutation.ListClassCleared() {
		_spec.ClearField(dictionarydetail.FieldListClass, field.TypeString)
	}
	if value, ok := ddu.mutation.CSSClass(); ok {
		_spec.SetField(dictionarydetail.FieldCSSClass, field.TypeString, value)
	}
	if ddu.mutation.CSSClassCleared() {
		_spec.ClearField(dictionarydetail.FieldCSSClass, field.TypeString)
	}
	if value, ok := ddu.mutation.IsDefault(); ok {
		_spec.SetField(dictionarydetail.FieldIsDefault, field.TypeUint32, value)
	}
	if value, ok := ddu.mutation.AddedIsDefault(); ok {
		_spec.AddField(dictionarydetail.FieldIsDefault, field.TypeUint32, value)
	}
	if ddu.mutation.IsDefaultCleared() {
		_spec.ClearField(dictionarydetail.FieldIsDefault, field.TypeUint32)
	}
...
// SetListClass sets the "list_class" field.
func (dduo *DictionaryDetailUpdateOne) SetListClass(s string) *DictionaryDetailUpdateOne {
	dduo.mutation.SetListClass(s)
	return dduo
}

// SetNillableListClass sets the "list_class" field if the given value is not nil.
func (dduo *DictionaryDetailUpdateOne) SetNillableListClass(s *string) *DictionaryDetailUpdateOne {
	if s != nil {
		dduo.SetListClass(*s)
	}
	return dduo
...
// ClearListClass clears the value of the "list_class" field.
func (dduo *DictionaryDetailUpdateOne) ClearListClass() *DictionaryDetailUpdateOne {
	dduo.mutation.ClearListClass()
	return dduo
}

// SetCSSClass sets the "css_class" field.
func (dduo *DictionaryDetailUpdateOne) SetCSSClass(s string) *DictionaryDetailUpdateOne {
	dduo.mutation.SetCSSClass(s)
	return dduo
}

// SetNillableCSSClass sets the "css_class" field if the given value is not nil.
func (dduo *DictionaryDetailUpdateOne) SetNillableCSSClass(s *string) *DictionaryDetailUpdateOne {
	if s != nil {
		dduo.SetCSSClass(*s)
	}
	return dduo
...
// ClearCSSClass clears the value of the "css_class" field.
func (dduo *DictionaryDetailUpdateOne) ClearCSSClass() *DictionaryDetailUpdateOne {
	dduo.mutation.ClearCSSClass()
	return dduo
}

// SetIsDefault sets the "is_default" field.
func (dduo *DictionaryDetailUpdateOne) SetIsDefault(u uint32) *DictionaryDetailUpdateOne {
	dduo.mutation.ResetIsDefault()
	dduo.mutation.SetIsDefault(u)
	return dduo
}

// SetNillableIsDefault sets the "is_default" field if the given value is not nil.
func (dduo *DictionaryDetailUpdateOne) SetNillableIsDefault(u *uint32) *DictionaryDetailUpdateOne {
	if u != nil {
		dduo.SetIsDefault(*u)
	}
	return dduo
...
// AddIsDefault adds u to the "is_default" field.
func (dduo *DictionaryDetailUpdateOne) AddIsDefault(u int32) *DictionaryDetailUpdateOne {
	dduo.mutation.AddIsDefault(u)
	return dduo
}

// ClearIsDefault clears the value of the "is_default" field.
func (dduo *DictionaryDetailUpdateOne) ClearIsDefault() *DictionaryDetailUpdateOne {
	dduo.mutation.ClearIsDefault()
	return dduo
}
...
func (dduo *DictionaryDetailUpdateOne) sqlSave(ctx context.Context) (_node *DictionaryDetail, err error) {
	...
	if value, ok := dduo.mutation.ListClass(); ok {
		_spec.SetField(dictionarydetail.FieldListClass, field.TypeString, value)
	}
	if dduo.mutation.ListClassCleared() {
		_spec.ClearField(dictionarydetail.FieldListClass, field.TypeString)
	}
	if value, ok := dduo.mutation.CSSClass(); ok {
		_spec.SetField(dictionarydetail.FieldCSSClass, field.TypeString, value)
	}
	if dduo.mutation.CSSClassCleared() {
		_spec.ClearField(dictionarydetail.FieldCSSClass, field.TypeString)
	}
	...
	if dduo.mutation.IsDefaultCleared() {
		_spec.ClearField(dictionarydetail.FieldIsDefault, field.TypeUint32)
	}
